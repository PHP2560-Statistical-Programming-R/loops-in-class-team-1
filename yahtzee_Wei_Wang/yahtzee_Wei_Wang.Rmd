...
if (x[1]==x[5]){
  hand="Yahtzee"
    ...
    hand="Three of a Kind"
} else if (x[4]==x[1]+3 & x[3]==x[1]+2 & x[2]==x[1]+1 & x[5]!=x[4]+1) {
   hand="Small Straight"
} else if (x[5]==x[2]+3 & x[4]==x[2]+2 & x[3]==x[2]+1 & x[1]!=x[2]-1) {
    hand="Small Straight"
} else if (x[5]==x[1]+4 & x[4]==x[1]+3 & x[3]==x[1]+2 & x[2]==x[1]+1) {
    hand="Large Straight"
} else
 hand="Chance"
}

hand = yahtzee_function(x)
...
if (x[1]==x[5]){
  hand[i]="Yahtzee"
   ...
   hand[i]="Small Straight"
    ...
    hand[i]="Large Straight"
} else
    hand[i]="Chance"
}

Hand_Probability <- table(hand) / 100000
Hand_Probability=as.data.frame(Hand_Probability)
names(Hand_Probability)=c("Hand","Probability")
Hand_Probability$Probability= round(Hand_Probability$Probability,digits=4)

Order <- c("Yahtzee", "Four of a Kind", "Three of a Kind", "Full House", "Large Straight", "Small Straight", "Chance")
Hand_Probability$Hand <- reorder.factor(Hand_Probability$Hand, new.order=Order)
Hand_Probability %>%
  arrange(Hand)
