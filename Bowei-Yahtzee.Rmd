...
if (length(unique(x)) == 1) {
  ...
  if (x[1]==x[4] || x[2]==x[5]) {
    ...
    if (x[1]==x[3] || x[2]==x[4] || x[3]==x[5]) {
      hand="3ofKind"
    } else hand="chance"} else if (length(unique(x))==4) {
      if (unique(x)[4]-unique(x)[3]==1 & unique(x)[3]-unique(x)[2]==1 & unique(x)[2]-unique(x)[1]==1) {
        hand="small straight"
      } else hand="chance"} else if (length(unique(x))==5 & x[5]-x[1]==4) {
        hand="large straight"
      } else if (x[5]-x[2]==3 || x[4]-x[1]==3) {
        hand="small straight"} else hand="chance"
